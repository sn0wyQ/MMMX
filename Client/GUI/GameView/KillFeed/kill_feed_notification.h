#ifndef CLIENT_GUI_GAMEVIEW_KILLFEED_KILL_FEED_NOTIFICATION_H_
#define CLIENT_GUI_GAMEVIEW_KILLFEED_KILL_FEED_NOTIFICATION_H_
...
#endif  // CLIENT_GUI_GAMEVIEW_KILLFEED_KILL_FEED_NOTIFICATION_H_
